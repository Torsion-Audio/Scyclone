...
# Only this repo's configure step pins -ToolsetVersion; other VS projects are unaffected.
#
# Usage:
...
$cmakeArgs = @(
    '--preset', $Preset,
    "-DCMAKE_C_COMPILER=$clExeForward",
    "-DCMAKE_CXX_COMPILER=$clExeForward"
)
if ($extraArgs) {
